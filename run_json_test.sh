...
echo "Executing: go run cmd/main.go -config configs/test_config.json --dry-run"
...
echo "Executing: go run cmd/main.go -config configs/test_config.json"
...
echo "Executing: go run cmd/main.go -config configs/test_config.json --list-versions"
go run cmd/main.go -config configs/test_config.json --list-versions

echo "\nShowing latest version..."
echo "Executing: go run cmd/main.go -config configs/test_config.json --latest-version"
